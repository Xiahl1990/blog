require([], function (){
    ...
    var loadMobile = function(){
        require([yiliaConfig.rootUrl + 'yelee/js/mobile.js'], function(mobile){
            mobile.init();
            isMobileInit = true;
        })
    }
    var isPCInit = false;
    var loadPC = function(){
        require([yiliaConfig.rootUrl + 'yelee/js/pc.js'], function(pc){
            pc.init();
            isPCInit = true;
        })
    }
    ...
    if(yiliaConfig.isArchive || yiliaConfig.isTag || yiliaConfig.isCategory) {
        $(document).ready(function() {
            var _text = yiliaConfig.isArchive ? "Archive":
            (yiliaConfig.isTag?"Tag":(yiliaConfig.isCategory?"Category":""));
            $("#footer").after("<button class='hide-labels'>"+ _text +"</button>");
